...
def main():
    ...
    for frame_num, player_track in enumerate(tracks['players']):
        for player_id , track in player_track.items():
            ...
            # tracks['players'][frame_num][player_id]['team']['team_color'] = team_assigner.team_colors[team]
    ...
    #Assign Ball Aquisition and team control
    ...
    #     cv2.imwrite(f'output_videos/cropped_image.png', cropped_image)
    #     break
